...
import (
	...
	"github.com/akhilmhdh/go-monkey-interpreter/token"
)
...
func TestNextToken(t *testing.T) {
   ...
   `
	...
	for i, testTok := range tests {
		...
		if tok.Type != testTok.expectType {
			t.Fatalf("test[%d] - tokentype wrong. expected=%q, got=%q", i, testTok.expectType, tok.Type)
		}
